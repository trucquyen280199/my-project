            ...
            <article className="contents" id="contents">
                ...
                <section>
                    <div id="device">
                        <div className="content-item" >
                            ...
                            <img src='./images/device-1.png' className="mb-3 w-75" />
                ...
                <section>
                    <div id="basic-search">
                        ...
                        <div className="content-item" >
                            <img src="./images/device-2.png" className="mb-3 w-75" />
                            <p className="font-weight-bold">Ghi chú:</p>
                            <table className="table table-list d-flex w-100 mt-3">
                                <tbody>
                                    <tr>
                ...
                <section>
                    <div id="details-and-configuration">
                        ...
                        <div className="content-item" >
                            <img src="./images/device-4.png" className="mb-3 w-75" />
                            <p className="ml-4">
                            Restore default<br />
                ...
                <section>
                    <div id="device-waiting">
                        ...
                        <div className="content-item" >
                            ...
                            <img src="./images/device-6.png" className="mb-3 w-75" />
                            <p className="font-weight-bold">Ghi chú:</p>
                            <table className="table table-list d-flex w-100 mt-3">
                                <tbody>
                                    <tr>
